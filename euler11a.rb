...
class EulerEleven
  ...
  #-----------------------------------------------------
  # This pushes a vertical rendering of the matrix into
  # the matrix
  vertical_matrix = []
  (0..19).each do |n|
    x = []
  ...
  #-----------------------------------------------------
  #This section pushes vertical renderings of the matrix
  # into the matrix.
  ...
  #-----------------------------------------------------
  # this evaluates the matrix array
  ...
  #-----------------------------------------------------
  # pushes values values to an eval_array to be sorted 
